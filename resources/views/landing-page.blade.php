                ...
                @else
                    ...
                    @else
                        <div class="container m-4">
                            <span class="text-justify">I can see you are a new user. The first step to use this app is to create a wallet.<br>
        ...
        <div class="modal-dialog modal-notify modal-warning" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn btn-default btn-primary" id="nameConfirm" data-url="{{route('confirmWalletName')}}">Confirm</button>
                </div>
            </div>
        </div>
    </div>
